...
Documentation theme for Statiq Docs using Bootstrap 5.

# Minimum Statiq Docs Version

This theme requires Statiq Docs 1.0.0-beta.3 or later.
...
```
git submodule add https://github.com/glennawatson/Docable5.git theme
```

Alternatively you can clone the theme directly:

```
git clone https://github.com/glennawatson/Docable5.git theme
```
